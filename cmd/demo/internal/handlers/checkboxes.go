		...
		html.Section(
			...
			html.Div(
				...
				html.Label(
					...
					checkbox.Checkbox(checkbox.Props{ID: "cb-updates", Name: "updates"}),
					html.Text("Email me product updates"),
				),
				html.Label(
					html.AClass("flex items-center gap-2"),
					checkbox.Checkbox(checkbox.Props{ID: "cb-terms", Name: "terms", Required: true}),
					html.Text("I agree to the terms"),
				),
				html.Label(
					html.AClass("flex items-center gap-2 text-muted-foreground"),
					checkbox.Checkbox(checkbox.Props{ID: "cb-disabled", Disabled: true}),
