...
const tabsJS = `(function(){
  ...
  function activate(tabsId, value){
    var triggers = document.querySelectorAll('[data-pui-tabs-trigger][data-pui-tabs-id="'+tabsId+'"]');
    var contents = document.querySelectorAll('[data-pui-tabs-content][data-pui-tabs-id="'+tabsId+'"]');
    triggers.forEach(function(trigger){
      var isActive = trigger.getAttribute('data-pui-tabs-value') === value;
      trigger.setAttribute('data-pui-tabs-state', isActive ? 'active' : 'inactive');
    });
    contents.forEach(function(panel){
      var isActive = panel.getAttribute('data-pui-tabs-value') === value;
      panel.setAttribute('data-pui-tabs-state', isActive ? 'active' : 'inactive');
